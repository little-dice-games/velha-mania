...
this["JST"]["apps/modals/show/templates/layout"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'modal-region\'></div>';

}
return __p
};

this["JST"]["apps/modals/show/templates/modal"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p +=
((__t = ( message )) == null ? '' : __t) +
'\n\n<a class=\'modal-button modal-button--yes\'>sim</a>\n<a class=\'modal-button modal-button--no\'>não</a>';
